...
const LeaderTopicsApplicationList: React.FC<IMentorTopicsPendingProps> = (props) => {
    ...
    try {
      const response = await axios.post(`${BASE_API_URL}/topics/leader/getTopicByFilter`, {
        filter: {
          ...
          topic_category: "6558300c60cbc25a341017a6"
        }
      }, { headers });
  ...
  const header = (
    <div className="flex flex-wrap items-center justify-between">
      <span className="text-base text-900 font-bold">Đề tài ứng dụng</span>
    </div>
  );
...
export default LeaderTopicsApplicationList;
